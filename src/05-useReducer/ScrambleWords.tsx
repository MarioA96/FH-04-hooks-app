...
export const ScrambleWords = () => {
    ...
    const handleGuessSubmit = (e: React.FormEvent) => {
        ...
        // console.log('intento:', guess, ", a adivinar", currentWord);
        ...
        if (guess === currentWord) {
            ...
            if (points === GAME_WORDS.length - 1) {
                ...
                /*
                * updatedWords[0] es la primera palabra del nuevo arreglo que acabas de 
                * calcular (words.slice(1)). Es el valor correcto del "siguiente" word que quieres mostrar.
                
                * currentWord es el estado actual antes de llamar a setWords/setCurrentWord. Las llamadas a setState son asíncronas: si usas scrambleWord(currentWord) inmediatamente después de 
                * setCurrentWord, estarías mezclando la palabra antigua (stale), no la nueva.
                */
